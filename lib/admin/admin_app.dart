...
// ============ MÓDULO 3: TARIFAS ============
class _TariffsModule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const _Header('Tarifas y comisiones',
                      ...
                      child: _card(
                        child: Row(
                          children: [
                            ...
                            _pill('Base S/ ${_num(c['tariff_base'])}'),
                            _pill('x Km S/ ${_num(c['tariff_per_km'])}'),
                            _pill('Comisión ${_num(c['commission_percent'])}%'),
                          ],
                        ),
                      ),
                    ),
  ...
  String _num(dynamic v) =>
      v == null ? '—' : (v is num ? v.toStringAsFixed(v == v.toInt() ? 0 : 2) : v.toString());
